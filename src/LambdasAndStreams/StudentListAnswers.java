...
public class StudentListAnswers {
    ...
    public static void main(String[] args) {
         ...
         *          o1.getFirstName()); //error here. This compares o1 to o1 instead of o1 to o2.
         *      } else {
        ...
        Collections.sort(friends, new Comparator<Student>() {
            public int compare(Student o1, Student o2) {
                int compareLast = o1.getLastName().compareTo(o2.getLastName());
